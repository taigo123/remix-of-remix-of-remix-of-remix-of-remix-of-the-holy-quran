...
const FEEDBACK_LABELS: Record<string, { feedback: string; newFeedback: string }> = {
  ...
  it: { feedback: 'Feedback', newFeedback: 'Nuovo feedback!' },
  nl: { feedback: 'Feedback', newFeedback: 'Nieuwe feedback!' },
  pl: { feedback: 'Opinie', newFeedback: 'Nowa opinia!' },
  ro: { feedback: 'Feedback', newFeedback: 'Feedback nou!' },
  sv: { feedback: 'Feedback', newFeedback: 'Ny feedback!' },
  ru: { feedback: 'Отзывы', newFeedback: 'Новый отзыв!' },
  uk: { feedback: 'Відгуки', newFeedback: 'Новий відгук!' },
  ...
  uz: { feedback: 'Fikr-mulohaza', newFeedback: 'Yangi fikr-mulohaza!' },
  az: { feedback: 'Rəy', newFeedback: 'Yeni rəy!' },
  kk: { feedback: 'Пікір', newFeedback: 'Жаңа пікір!' },
  tt: { feedback: 'Фикер', newFeedback: 'Яңа фикер!' },
  bs: { feedback: 'Povratne informacije', newFeedback: 'Nove povratne informacije!' },
  sq: { feedback: 'Reagime', newFeedback: 'Reagim i ri!' },
  bg: { feedback: 'Обратна връзка', newFeedback: 'Нова обратна връзка!' },
  cs: { feedback: 'Zpětná vazba', newFeedback: 'Nová zpětná vazba!' },
  am: { feedback: 'አስተያየት', newFeedback: 'አዲስ አስተያየት!' },
  so: { feedback: 'Jawaab-celin', newFeedback: 'Jawaab-celin cusub!' },
  sw: { feedback: 'Maoni', newFeedback: 'Maoni mapya!' },
  ha: { feedback: "Ra'ayi", newFeedback: "Sabon ra'ayi!" },
  yo: { feedback: 'Idahun', newFeedback: 'Idahun tuntun!' },
  ml: { feedback: 'ഫീഡ്ബാക്ക്', newFeedback: 'പുതിയ ഫീഡ്ബാക്ക്!' },
  ta: { feedback: 'கருத்து', newFeedback: 'புதிய கருத்து!' },
  te: { feedback: 'అభిప్రాయం', newFeedback: 'కొత్త అభిప్రాయం!' },
  si: { feedback: 'ප්‍රතිචාර', newFeedback: 'නව ප්‍රතිචාරයක්!' },
  ne: { feedback: 'प्रतिक्रिया', newFeedback: 'नयाँ प्रतिक्रिया!' },
  dv: { feedback: 'ފީޑްބެކް', newFeedback: 'އައު ފީޑްބެކް!' },
};
